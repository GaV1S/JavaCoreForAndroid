...
import com.google.guava.common.collect.Maps;
...
public class MySQL5PlayerDAO extends PlayerDAO {
    ...
    public void storePlayer(final Player player) {
        ...
        try {
            ...
            stmt.setInt(41, pcd.getLunaCoins());
            stmt.setInt(42, pcd.getWardrobeSize());
    ...
    public boolean saveNewPlayer(final PlayerCommonData pcd, final int accountId, final String accountName) {
        ...
        try {
            con = DatabaseFactory.getConnection();
            PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO players(id, `name`, account_id, account_name, x, y, z, heading, world_id, gender, race, player_class , cube_expands, warehouse_size, bonus_type, online, luna_coins, wardrobe_size) "
                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)");
            ...
            preparedStatement.setInt(16, pcd.getLunaCoins());
            preparedStatement.setInt(17, pcd.getWardrobeSize());
    ...
    public PlayerCommonData loadPlayerCommonData(final int playerObjId) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                cd.setLunaCoins(resultSet.getInt("luna_coins"));
